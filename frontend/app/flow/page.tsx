...
const STEPS: StepDef[] = [
  {
    ...
    rows: [
      ...
      { label: "DEVICE",     value: "Android 14 · 31-feature vector extracted" },
  ...
  },
  {
    ...
    kicker:
      "Random Forest · 300 estimators · SMOTE oversampling · 90.75 % accuracy (JETIR 2024)",
    rows: [
      { label: "FEATURES",       value: "31  (PaySim-derived + velocity-engineered)" },
      { label: "MODEL",          value: "Random Forest + XGBoost ensemble" },
      { label: "INFERENCE",      value: "300 trees → ensemble vote" },
